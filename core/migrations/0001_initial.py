# Generated by Django 4.2.13 on 2024-06-13 02:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount_rate', models.CharField(choices=[('second', 'Per Second'), ('minute', 'Per Minute'), ('hour', 'Per Hour'), ('day', 'Per Day'), ('week', 'Per Week'), ('month', 'Per Month')], default='hour', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount_rate', models.CharField(choices=[('second', 'Per Second'), ('minute', 'Per Minute'), ('hour', 'Per Hour'), ('day', 'Per Day'), ('week', 'Per Week'), ('month', 'Per Month')], max_length=10)),
                ('is_enabled', models.BooleanField(default=True)),
                ('rule_application_period', models.CharField(blank=True, max_length=255, null=True)),
                ('days', models.ManyToManyField(to='core.day')),
                ('location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.location')),
                ('months', models.ManyToManyField(to='core.month')),
                ('years', models.ManyToManyField(to='core.year')),
            ],
        ),
    ]
